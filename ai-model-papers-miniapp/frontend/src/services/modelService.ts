...
class ModelService implements IModelService {
  ...
  async getModels(params?: ModelQueryParams): Promise<APIResponse<Model[]>> {
    return this.httpClient.get<APIResponse<Model[]>>('/models', params as Record<string, unknown>);
  }
